...
function NavBar2() {
  ...
  return (
    <div className="flex justify-center items-center sm:gap-[2rem] gap-[1rem] my-[25px] mx-[1rem]">
      ...
      <Link to='/ingreso' class="w-[12rem] h-[50px] px-[18px] py-[13px] bg-[#0477AD] rounded-[8px] overflow-hidden justify-center items-center gap-[4px] flex">
       {/*  <Link to='/ingreso'> */}
      ...
      <Link to='/ingreso_policial' class="flex w-[12rem] h-[50px] px-[18px] py-[13px] bg-white rounded-[8px] overflow-hidden border border-[#0477AD] justify-center items-center gap-[4px]">

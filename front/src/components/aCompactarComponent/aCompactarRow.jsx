...
const ACompactarRow = ({ actaNro, marcaModelo, dominio, checked, onCheck, loadingItem, permiteCompactacion }) => {
  return (
    <div className="h-20 bg-white border-b border-[#c5dfff] flex items-center px-4">
      ...
      <div className="flex justify-center flex-[0.5]">
        {permiteCompactacion === false ? (
          <p className="text-[#3d4245] text-xs sm:text-base font-inter">
            Juzgado no permite compactar
          </p>
        ) : loadingItem ? (
          <svg
            aria-hidden="true"

...
import SubirFotoLicencia from "./subirFotoLicencia";
import { useState } from "react";
import { limpiarFotoLicencia } from "../../redux/actions";


function OpcionesFotoLicencia({ closeOpcionesFotoLicencia, openTakeFotoLicencia, openConfirmarDatosLicencia, openOpcionesFotoLicencia }) {
  ...
  //----Limpiar store si la licencia se sube sin foto-----//
  const handlePostearSinFoto = async () => {
    await dispatch(limpiarFotoLicencia()); // Limpiar foto del store
  ...
  return (
    <div
      ...
      onClick={closeOpcionesFotoLicencia} /* Cierra al hacer clic fuera */
    >
      {!imagen ? (
        <div
            ...
            >
              ...
              <div className="flex-col justify-start items-start gap-1 inline-flex">
                ...
                <div className="text-[#687073] text-sm font-normal font-inter">
                  Capturar una foto de la licencia a ingresar
                </div>
              </div>
            </button>
            <label
        ...
        <SubirFotoLicencia imagen={imagen} preview={preview} handleBack={handleBack} openConfirmarDatosLicencia={openConfirmarDatosLicencia} />
      )}
    </div>
...
export default OpcionesFotoLicencia;

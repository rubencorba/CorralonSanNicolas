      ...
      <div className="flex min-h-screen flex-col  items-center bg-[#F5FAFF]">
        ...
        {imagen ? (
          <div className="flex flex-col  items-center">
            <img src={preview} alt="Captura" className=" mt-[4rem] rounded-lg overflow-hidden" />
          ...
          <div className="flex flex-col  items-center">
            <div className=" mt-[4rem] rounded-lg overflow-hidden">
              <Webcam
                audio={false}
            ...
            <div className=" mt-[4rem] justify-center items-center flex">
              <div className="w-[21.5rem] justify-center items-center gap-2 inline-flex">
                <button onClick={() => handleback()} className="w-full h-[50px] px-[10px] py-[13px] bg-white rounded-lg border-[#0477ad] border justify-center items-center  flex">
                  <div className="text-[#0477ad] text-base font-semibold font-inter">Volver atrás</div>
                </button>
